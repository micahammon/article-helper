# rules.py (Comprehensive Version)
# This file contains the expanded logic and data for the English Article Helper.

# ==============================================================================
# LOOKUP TABLE (FOR FIXED WORDS AND EXCEPTIONS)
# ==============================================================================
# Based on Sections 4, 6, 7, and 9 of the PDF.
# This table provides instant answers for specific nouns with fixed rules.

LOOKUP_TABLE = {
    # --- Section 4: 'The' for Abstract Ideas & Systems ---
    ...
    # --- Section 4.15 & 6: 'No Article' for Abstract Ideas & Categories ---
    ...
    # --- Section 7.4 & 7.5: Special Cases (Institutions, Illnesses) ---
    ...
    # --- Section 9: Proper Nouns (Examples) ---
...
# ==============================================================================
# DECISION TREE (FOR CONCEPTUAL RULES)
# ==============================================================================

# In rules.py, replace the DECISION_TREE with this:
...
DECISION_TREE = {
    ...
    # (The rest of the result nodes and other checks can remain the same)
    "noun_number_check": {
        "article": "no article",
        "explanation": "When a noun is followed by a classifying number or letter (e.g., Platform 9, Page 42, Question B), you use no article.",
        "rule_ref": "6.3"
    },
    "uncountable_adjective_check": {
        "article": "a / an",
        "explanation": "In formal or literary English, you can use 'a/an' with an uncountable noun if you are describing a *particular type* of it, usually with an adjective (e.g., 'a profound sadness', 'an excellent knowledge of history').",
        "rule_ref": "7.2"
    },
